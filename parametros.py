...
MIN_POPULACAO = 25
MAX_POPULACAO = 100
MIN_MAX_GERACOES = 100
MAX_MAX_GERACOES = 10000
MIN_GERACOES_SEM_MELHORIA = 100
MAX_GERACOES_SEM_MELHORIA = 5000
...
# Mapeamento de tipos de transporte (ID -> Nome)
TIPO_TRANSPORTE_MAP = {
    TIPO_TRANSPORTE_AVIAO: "Avião",
    TIPO_TRANSPORTE_TREM: "Trem",
    TIPO_TRANSPORTE_CARRO_ELETRICO: "Carro Elétrico",
    TIPO_TRANSPORTE_CAMINHAO: "Caminhão"
}
